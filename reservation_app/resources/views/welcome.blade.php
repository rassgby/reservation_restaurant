...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['login'])) {
    ...
    // Simulation de vérification (dans un cas réel, vérifier avec la base de données)
    if ($email === 'test@example.com' && $password === 'password') {
        $_SESSION['user_id'] = 1;
        $_SESSION['user_name'] = 'Client Test';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['register'])) {
    ...
    if (empty($name) || empty($email) || empty($password)) {
        ...
        // Dans un cas réel, enregistrer l'utilisateur dans la base de données
...
<body class="bg-restaurant-light text-restaurant-dark font-sans">
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap items-center justify-between py-3">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="flex flex-col items-center">
                        ...
                        <span class="text-restaurant-gold"><?= htmlspecialchars($_SESSION['user_name']) ?></span>
                    </div>
                    <a href="?logout=1"
            ...
            <div id="mobile-menu" class="hidden md:hidden pb-4">
                <div class="flex flex-col space-y-3">
                    ...
                    <?php else: ?>
                    <button id="showLoginBtnMobile"
                        class="hover:text-restaurant-gold transition-colors duration-300 py-2 px-3 flex items-center space-x-2">
                        <i class="fas fa-sign-in-alt"></i>
                        <span>Connexion</span>
                    </button>
                    <button id="showRegisterBtnMobile"
        ...
        <section id="menu" class="py-16 md:py-24">
            ...
            <div class="category-section mb-16" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <?php foreach ($menu['entrees'] as $plat): ?>
                    <div class="menu-card bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-xl"
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-gray-600 leading-relaxed"><?= htmlspecialchars($plat['description']) ?></p>
                        </div>
                    </div>
                    <?php endforeach; ?>
                </div>
    ...
    <div id="loginModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-8 max-w-md w-full">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-serif font-bold">Connexion</h3>
            ...
            <form method="post" action="{{ route('login') }}">
                ...
                <button type="submit" name="login"
                    class="w-full px-6 py-3 bg-restaurant-gold text-restaurant-dark font-bold rounded-md hover:bg-opacity-90 transition-colors duration-300">
                    Se connecter
                </button>
                <div class="text-center mt-4">
                    <p class="text-gray-600">Vous n'avez pas de compte ?
                        <button type="button" id="switchToRegister"
                            class="text-restaurant-gold hover:underline">S'inscrire</button>
                    </p>
                </div>
            </form>
        </div>
    ...
    <div id="registerModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
        <div class="bg-white rounded-lg p-8 max-w-md w-full">
            <div class="flex justify-between items-center mb-6">
                <h3 class="text-xl font-serif font-bold">Inscription</h3>
                <button class="closeModal text-gray-500 hover:text-gray-700">
                    <i class="fas fa-times"></i>
                </button>
            </div>
            ...
            <form method="POST" action="{{ route('regist') }}">
                ...
                <div class="mb-4">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="register-password">Mot de
                        passe</label>
                ...
                <!-- <div class="mb-6">
                    <label class="block text-gray-700 text-sm font-bold mb-2" for="register-confirm-password">Confirmer
                ...
                <div class="text-center mt-4">
                    <p class="text-gray-600">Vous avez déjà un compte ?
                        <button type="button" id="switchToLogin" class="text-restaurant-gold hover:underline">Se
                            connecter</button>
                    </p>
                </div>
            </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const showLoginBtnMobile = document.getElementById('showLoginBtnMobile');
            const showRegisterBtn = document.getElementById('showRegisterBtn');
            const showRegisterBtnMobile = document.getElementById('showRegisterBtnMobile');
            ...
            if (showLoginBtnMobile) showLoginBtnMobile.addEventListener('click', () => showModal(loginModal));
            if (showRegisterBtn) showRegisterBtn.addEventListener('click', () => showModal(registerModal));
            if (showRegisterBtnMobile) showRegisterBtnMobile.addEventListener('click', () => showModal(registerModal));
