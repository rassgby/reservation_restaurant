        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex justify-between h-20">
            <div className="flex items-center">
              <h1 className={`text-2xl font-bold font-sans italic ${scrolled ? 'text-rose-300' : 'text-white'}`}>L'Élégance</h1>
            </div>
            <div className="flex items-center space-x-8">
              ...
              <button
                ...
                className="bg-rose-600 text-white px-6 py-2 rounded-full hover:bg-rose-700 transition-colors shadow-md shadow-rose-900/20 text-sm uppercase tracking-widest"
              >
                Réserver
              </button>
            </div>
